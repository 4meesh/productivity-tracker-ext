<template>
  <div class="headerBlock">
    ...
    <div class="icons-block">
      <div>
        <span class="dark-mode-icon" v-if="darkMode == true" @click="changeDarkMode(false)">[Light Mode]</span>
        <span class="dark-mode-icon" v-if="darkMode == false" @click="changeDarkMode(true)">[Dark Mode]</span>

        <a @click="openPage(SettingsTab.Pomodoro)">
          {{ t('pomodoroMode.message') }} <span>[Pomodoro Icon]</span>
        </a>
        <a class="filter" @click="openPage(SettingsTab.Dashboard)">
          {{ t('dashboard.message') }} <span>[Dashboard Icon]</span>
        </a>
        <a class="filter" @click="openPage(SettingsTab.GeneralSettings)">
          {{ t('settings.message') }} <span>[Settings Icon]</span>
        </a>
      </div>
    </div>
  </div>
